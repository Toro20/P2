...
public times: ConvertedTimes = {
  ...
  public welcomeMessages: WelcomeMessages = {
 ...
 //     this.rooms=ROOMS;
  ...
  getConvertedTimes() {
      this.httpClient.get<ConvertedTimes>(this.baseURL + "/resources/time-conversions")
        .subscribe(
          (times) => {
            this.times = times;
  ...
  getWelcomeMessages() {
    this.httpClient.get<WelcomeMessages>(this.baseURL + "/resources/welcomemessages")
      .subscribe(
        (messages) => {
          this.welcomeMessages = messages;
          console.log("Received Welcome Messages:", messages);
        },
        (error) => {
...
export interface ConvertedTimes {
ettime: string;
mttime: string;
utctime: string;
}
